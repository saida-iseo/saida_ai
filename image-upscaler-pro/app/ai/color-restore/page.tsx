...
export default function ColorRestorePage() {
    ...
    const handleUpload = async (files: File[]) => {
        ...
        router.push('/ai/color-restore/editor');
    };

    return (
        <div className="min-h-[calc(100vh-64px)] bg-background flex flex-col items-center justify-center p-6">
            <div className="w-full max-w-4xl text-center mb-12">
                <h1 className="text-5xl font-black text-text-primary tracking-tighter mb-4">AI 색상 복원</h1>
                <p className="text-text-secondary font-bold">밝기와 채도를 보정해 생동감을 되살립니다.</p>
            </div>
