...
export default function DenoisePage() {
    ...
    const handleUpload = async (files: File[]) => {
        ...
        router.push('/ai/denoise/editor');
    };

    return (
        <div className="min-h-[calc(100vh-64px)] bg-background flex flex-col items-center justify-center p-6">
            <div className="w-full max-w-4xl text-center mb-12">
                <h1 className="text-5xl font-black text-text-primary tracking-tighter mb-4">AI 노이즈 제거/선명화</h1>
                <p className="text-text-secondary font-bold">노이즈를 줄이고 선명도를 개선합니다.</p>
            </div>
