...
export default function FramePage() {
    ...
    const handleUpload = async (files: File[]) => {
        ...
        router.push('/tools/frame/editor');
    };

    return (
        <div className="min-h-[calc(100vh-64px)] bg-background flex flex-col items-center justify-center p-6">
            <div className="w-full max-w-4xl text-center mb-12">
                <h1 className="text-5xl font-black text-text-primary tracking-tighter mb-4">프레임</h1>
                <p className="text-text-secondary font-bold">색상과 두께를 선택해 프레임을 추가하세요.</p>
            </div>
